...
public class AwsGreengrassProvisionerModule extends AbstractModule {
    ...
    public void configure() {
        ...
        bind(IotClient.class).toProvider(new V2SafeProvider<>(IotClient::create));
        bind(Ec2Client.class).toProvider(new V2SafeProvider<>(Ec2Client::create));
        bind(CloudWatchLogsClient.class).toProvider(new V2SafeProvider<>(CloudWatchLogsClient::create));
        bind(GreengrassClient.class).toProvider(new V2SafeProvider<>(GreengrassClient::create));
        bind(LambdaClient.class).toProvider(new V2SafeProvider<>(LambdaClient::create));
        bind(CloudFormationClient.class).toProvider(new V2SafeProvider<>(CloudFormationClient::create));
        bind(EcrClient.class).toProvider(new V2SafeProvider<>(EcrClient::create));
        bind(SecretsManagerClient.class).toProvider(new V2SafeProvider<>(SecretsManagerClient::create));
        ...
        bind(JavaResourceHelper.class).to(BasicJavaResourceHelper.class);
        bind(GreengrassResourceHelper.class).to(BasicGreengrassResourceHelper.class);
